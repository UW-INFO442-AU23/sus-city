        ...
        <div className="overlap">
          ...
          <div className="overlap-group">
            ...
            <p className="text-wrapper-10">
              Carbon emissions are a critical issue because they are the primary
              drivers of climate change. The excess carbon dioxide in our
              atmosphere traps heat, leading to global warming, which in turn
              results in more extreme weather events, rising sea levels, and
              threats to our ecosystems. These changes affect everything from
              food production to water resources and can even impact your health
              due to increased air pollution. By caring about carbon emissions,
              you can play a part in mitigating these effects, ensuring a
              sustainable and healthier future for yourself, your community, and
              the entire planet.
            </p>
          ...
          <p className="text-wrapper-14">
            Your Guide to Sustainable Transportation Solutions for a Greener
            Future.
          </p>
